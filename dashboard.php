	...
	<div class="col-lg-2">
		...
		<div class="card text-center bg-dark text-white mb-3">
			<div class="card-body">
				...
				<h4 class="display-5"><i class="fa fa-users"></i>
					<?php
					echo totaladmins($con);
					?>
				</h4>
			</div>
		</div>
			...
			<div class="card-body">
				...
				<h4 class="display-5"><i class="fa fa-comment"></i>
					<?php
					echo totalcomments($con);
					?>
				</h4>
			</div>
		</div>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<tr>
					...
					<td><a href="fullpost.php?id=<?php echo $Id; ?>" target="_blank" class="btn btn-primary">Live</a></td>
				</tr>
			</tbody>
		<?php } ?>
		</table>
