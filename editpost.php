...
if(isset($_POST['sub'])){
	...
	if(empty($postitle)){
		...
		redirect('posts.php');
	}elseif (strlen($postarea)>9999) {
		$_SESSION['ErrorMsg']="Post Description must be less than 9999";
		redirect('posts.php');
	}else{
		if(!empty($_FILES['image']['name'])){
			$sql="update posts set title='$postitle', category='$catpost', image='$image', post='$postarea' where id='$posid'";
		}else{
		$sql="update posts set title='$postitle', category='$catpost', post='$postarea' where id='$posid'";
	}
		$stmt=$con->query($sql);
...
<header class="bg-dark text-white py-3">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1><i class="fa fa-edit cl"></i>Edit Post</h1>
			</div>
		</div>
	</div>
</header> 
...
<section class="container py-2 mb-4">
	<div class="row">
		<div class="offset-lg-1 col-md-10 min">
			...
			?>
			<form action="editpost.php?id=<?php echo $posid ?>" method="post" enctype="multipart/form-data">
				<div class="card bg-secondary text-light mb-3">
					...
					<div class="card-body bg-dark">
						<div class="form-group">
							...
							<input type="text" name="postitle" id="title" placeholder="Enter the post title" value="<?php echo $etitle; ?>" class="form-control">
						</div>
						<div class="form-group">
	      ...
	      <input type="file" class="custom-file-input" id="imgselect" name="image">
						...
						<div class="form-group">
							...
							<textarea rows="10" cols="15" class="form-control" id="post-area" name="postarea">
							<?php echo $epost; ?>
							</textarea>
						</div>
						<div class="row">
